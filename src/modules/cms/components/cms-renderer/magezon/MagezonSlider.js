                            ...
                            {link_type === 'button' && (
                                <div
                                    className={cx('magezon-slide-button', {
                                        'justify-start mobile:max-tablet:justify-center': content_align === 'left',
                                        'justify-end mobile:max-tablet:justify-center': content_align === 'right',
                                        'justify-center mobile:max-tablet:justify-center': content_align === 'center',
                                    })}
                                >
                                    {button1 && (
                                        <MagezonButton
                                            link={button1_link}
                                            title={button1}
                                            icon="fas mgz-fa-arrow-circle-right"
                                            icon_position="right"
                                            icon_size="xs"
                                            button_size={`${button1_size || 'sm'}`}
            ...
            <style jsx>
                {`
                    ...
                    .magezon-slider--button-nav-item:hover {
                        ${owl_hover_background_color ? `background-color: ${owl_hover_background_color};` : 'background: rgba(18, 18, 18, 0.60);'}
                    }
